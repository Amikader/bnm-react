...
const MesApp = ({page,setPage,setTotalPages,dateConge,dureeConge,typeConge}) => {
    ...
    const nouvelle = ()=>{
        try{
            API.get(`api/info-demande/?dateCongee=${dateConge}&dureeCongee=${dureeConge}&typecongee=${typeConge}&p=${page}&user=${auth.user_id}&approuver=true`)
            .then((response)=>{
